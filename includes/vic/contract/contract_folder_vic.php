...
{   
    ...
    $rcontract = mysql_query("UPDATE ver_chronoforms_data_contract_list_vic SET status = 'deleted' WHERE projectid = '$projectid'");
    $rcdetails = mysql_query("UPDATE ver_chronoforms_data_contract_details_vic SET status = 'deleted' WHERE projectid = '$projectid'");
    $rcvergola = mysql_query("UPDATE ver_chronoforms_data_contract_vergola_vic SET status = 'deleted' WHERE projectid = '$projectid'");
    $rcstatutory = mysql_query("UPDATE ver_chronoforms_data_contract_statutory_vic SET status = 'deleted' WHERE projectid = '$projectid'"); 
    $rcitems = mysql_query("UPDATE ver_chronoforms_data_contract_items_vic SET status = 'deleted' WHERE projectid = '$projectid'"); 
    $rccontractDeminsions = mysql_query("UPDATE ver_chronoforms_data_contract_items_deminsions SET status = 'deleted' WHERE projectid = '$projectid'"); 
    $rcbom = mysql_query("UPDATE ver_chronoforms_data_contract_bom_vic SET status = 'deleted' WHERE projectid = '$projectid'"); 
    $rcbom_m = mysql_query("UPDATE ver_chronoforms_data_contract_bom_meterial_vic SET status = 'deleted' WHERE projectid = '$projectid'"); 
    $rletter = mysql_query("UPDATE ver_chronoforms_data_letters_vic SET status = 'deleted' WHERE clientid='{$cust_id}' AND template_type='check list - gutter flashing' OR template_type='check list' ");  // no need to be included in filter parameter for commit because the content could be included or not.  
